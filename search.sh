...
./search_by_double_filtering.sh sketch_w$width QPSMAP_p$smap 00_23 otest NONE NONE $rs_dir 30 0 $qbit 2.0 0.5 10 25 8 7 13 3 1.05 100 0 8 $ftr 1 $batch $summary NONE
